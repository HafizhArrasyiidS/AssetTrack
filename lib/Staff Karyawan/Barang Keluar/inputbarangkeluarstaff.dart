...
class Inputbarangkeluarstaff extends StatefulWidget {
  const Inputbarangkeluarstaff({super.key});

  @override
  State<Inputbarangkeluarstaff> createState() => _InputbarangkeluarstaffState();
}

class _InputbarangkeluarstaffState extends State<Inputbarangkeluarstaff> {
  String? selectedItem;
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        Get.to(const Barangkeluarstaff());
