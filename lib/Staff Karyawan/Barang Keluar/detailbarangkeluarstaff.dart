import 'dart:io';
import 'package:assettrack2/Staff%20Karyawan/Barang%20Keluar/editbarangkeluarstaff.dart';
...
class Detailbarangkeluarstaff extends StatefulWidget {
  final String barangId; // Ambil ID barang dari halaman sebelumnya
  const Detailbarangkeluarstaff({super.key, required this.barangId});

  @override
  State<Detailbarangkeluarstaff> createState() => _DetailbarangkeluarstaffState();
}

class _DetailbarangkeluarstaffState extends State<Detailbarangkeluarstaff> {
          ...
          GestureDetector(
            onTap: () {
              if (barangData != null && widget.barangId.isNotEmpty) {
                Get.to(Editbarangkeluarstaff(
                  barangId: widget.barangId,
                  jumlahMasuk: barangData!['Jumlah_keluar'].toString(),
          ...
          : Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    barangData!['Jumlah_keluar'].toString(),
                    style: const TextStyle(
                      fontSize: 16,
                      fontFamily: 'poppins',
                      fontWeight: FontWeight.w400,
