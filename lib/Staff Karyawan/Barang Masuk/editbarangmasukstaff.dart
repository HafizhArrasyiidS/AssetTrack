import 'package:assettrack2/Admin/Barang%20Masuk/barangmasukad.dart';
...
class Editbarangmasukstaff extends StatefulWidget {
  ...
  @override
  State<Editbarangmasukstaff> createState() => _EditbarangmasukstaffState();
}

class _EditbarangmasukstaffState extends State<Editbarangmasukstaff> {
  ...
  Future<void> _updateBarang() async {
    try {
      ...
      DocumentSnapshot docSnapshot = await FirebaseFirestore.instance
          ...
          .doc(widget.barangId)
          .get();
      int previousJumlahMasuk = docSnapshot['Jumlah_masuk'];
      ...
      Get.to(Barangmasukstaff()); // Kembali setelah update berhasil
  ...
  Future<void> _deleteBarang() async {
    try {
      ...
      Get.to(Barangmasukstaff()); // Kembali setelah penghapusan berhasil
