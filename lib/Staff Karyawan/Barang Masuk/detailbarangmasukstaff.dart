import 'dart:io';
import 'package:assettrack2/Staff%20Karyawan/Barang%20Masuk/editbarangmasukstaff.dart';
...
class Detailbarangmasukstaff extends StatefulWidget {
  final String barangId; // Ambil ID barang dari halaman sebelumnya
  const Detailbarangmasukstaff({super.key, required this.barangId});

  @override
  State<Detailbarangmasukstaff> createState() => _DetailbarangmasukstaffState();
}

class _DetailbarangmasukstaffState extends State<Detailbarangmasukstaff> {
