import 'package:assettrack2/Admin/Barang%20Keluar/detailbarangkeluarad.dart';
import 'package:assettrack2/Admin/Barang%20Keluar/inputbarangkeluarad.dart';
...
class Barangkeluarad extends StatefulWidget {
  const Barangkeluarad({super.key});

  @override
  State<Barangkeluarad> createState() => _BarangkeluaradState();
}

class _BarangkeluaradState extends State<Barangkeluarad> {
            ...
            Expanded(
              child: AnimatedList(
                ...
                itemBuilder: (context, index, animation) {
                  ...
                  final int jumlahKeluar = docData['Jumlah_keluar'] as int? ?? 0;
