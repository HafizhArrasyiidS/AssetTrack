...
import 'editbarangkeluarad.dart';


class Detailbarangkeluarad extends StatefulWidget {
  final String barangId; // Ambil ID barang dari halaman sebelumnya
  const Detailbarangkeluarad({super.key, required this.barangId});

  @override
  State<Detailbarangkeluarad> createState() => _DetailbarangkeluaradState();
}

class _DetailbarangkeluaradState extends State<Detailbarangkeluarad> {
