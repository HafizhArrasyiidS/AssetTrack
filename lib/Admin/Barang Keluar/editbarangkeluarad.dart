...
class Editbarangkeluarad extends StatefulWidget {
  ...
  @override
  State<Editbarangkeluarad> createState() => _EditbarangkeluaradState();
}

class _EditbarangkeluaradState extends State<Editbarangkeluarad> {
  ...
  Future<void> _updateBarang() async {
    try {
      ...
      Get.to(Barangkeluarad()); // Kembali setelah update berhasil
  ...
  Future<void> _deleteBarang() async {
    try {
      ...
      Get.to(Barangkeluarad()); // Kembali setelah penghapusan berhasil
