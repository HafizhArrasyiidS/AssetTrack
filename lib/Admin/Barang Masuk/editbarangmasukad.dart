...
class Editbarangmasukad extends StatefulWidget {
  ...
  @override
  State<Editbarangmasukad> createState() => _EditbarangmasukadState();
}

class _EditbarangmasukadState extends State<Editbarangmasukad> {
  ...
  Future<void> _updateBarang() async {
    try {
      ...
      Get.to(Barangmasukad()); // Kembali setelah update berhasil
  ...
  Future<void> _deleteBarang() async {
    try {
      ...
      Get.to(Barangmasukad()); // Kembali setelah penghapusan berhasil
