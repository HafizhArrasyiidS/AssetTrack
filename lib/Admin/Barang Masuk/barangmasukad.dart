import 'package:assettrack2/Admin/Barang%20Masuk/detailbarangmasukad.dart';
import 'package:assettrack2/Admin/Barang%20Masuk/inputbarangmasukad.dart';
import 'package:assettrack2/Admin/bar/bottomnavad.dart';
import 'package:assettrack2/Admin/bar/drawerad.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:get/get.dart';

class Barangmasukad extends StatefulWidget {
  const Barangmasukad({super.key});

  @override
  State<Barangmasukad> createState() => _BarangmasukadState();
}

class _BarangmasukadState extends State<Barangmasukad> {
            ...
            Expanded(
              child: AnimatedList(
                ...
                itemBuilder: (context, index, animation) {
                  ...
                  final int jumlahKeluar = docData['Jumlah_masuk'] as int? ?? 0;
                      ...
                      SizeTransition(
                        ...
                        child: Card(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text('Jumlah Masuk: $jumlahKeluar'),
                            trailing: const Icon(Icons.chevron_right),
                            onTap: () {
                              Get.to(Detailbarangmasukad(
